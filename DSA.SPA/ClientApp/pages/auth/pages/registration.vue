    ...
    <div class="panel panel-body login-form">
      ...
      <div class="form-group has-feedback has-feedback-left">
        <input
          type="text"
          class="form-control"
          :placeholder="labels.properties.emailLable"
          v-model="user.email"
      ...
      <div class="form-group has-feedback has-feedback-left">
        <input
          type="text"
          class="form-control"
          :placeholder="labels.properties.fullNameLabel"
      ...
      <div class="content-divider text-muted form-group"><span>Do you have an account ?</span></div>
      <router-link to="/login" class="btn btn-default btn-block content-group">Sing In</router-link>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    fullNameErrors() {
      ...
      !this.$v.user.fullName.required &&
        errors.push(
          authTextResources.lables.validationMessages.fullNameRequiredMessage
        );
      return errors;
    }
  }
