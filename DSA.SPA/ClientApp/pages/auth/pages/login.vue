    ...
    <div>
        <div class="panel panel-body login-form">
            ...
            <div class="form-group">
                <button type="submit" @click="submit" :disabled="isInvaild" class="btn bg-teal btn-block btn-lg">Login</button>
            </div>
        
            <router-link to="/registr" class="btn btn-default btn-block content-group">Create New</router-link>
        </div>
    </div>
</template>
