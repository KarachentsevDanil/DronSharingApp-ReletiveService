<template>
  <!-- Primary modal -->
  <div id="addManipulation" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header bg-primary">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Add Manipulation</h4>
        </div>
...
export default {
  ...
  methods: {
    ...
    async addManipulation() {
      ...
      await manipulationService.addManipulation(data);

      $(".close-add-popup").click();

      this.clearForm();
      this.$noty.success("Manipulation was successfully added.");
